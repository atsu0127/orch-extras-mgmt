/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec2649f8410a0c21abc610e7f56d1739)
// Runtime types generated with workerd@1.20260722.1 2026-07-25 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PASSWORD_PEPPER: string;
	ADMIN_INITIAL_PASSWORD: string;
	EXTRA_INITIAL_PASSWORD: string;
	ASSISTANT_STUB: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PASSWORD_PEPPER" | "ADMIN_INITIAL_PASSWORD" | "EXTRA_INITIAL_PASSWORD" | "ASSISTANT_STUB" | "ANTHROPIC_API_KEY" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID" | "AI_GATEWAY_TOKEN">> {}
}
